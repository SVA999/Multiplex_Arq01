...
namespace FinalMultiplex.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Duracion,EdadMinima,Genero")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Duracion,EdadMinima,Genero")] Pelicula pelicula)
        {
            if (id != pelicula.Id)
            {
                return NotFound();
